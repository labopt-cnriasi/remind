# Generated by Django 3.0.6 on 2020-09-02 15:53
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('load_capacity', models.PositiveIntegerField(default=1, validators=[django.core.validators.MaxValueValidator(2)], verbose_name='Casse trasportabili')),
                ('is_available', models.BooleanField(default=True, verbose_name='disponibilità al servizio')),
                ('head', models.ForeignKey(limit_choices_to={'trasporter_type': 'motrice'}, on_delete=django.db.models.deletion.PROTECT, related_name='head', to='allapps.Transporter', verbose_name='Motrice')),
                ('trailer', models.ForeignKey(blank=True, limit_choices_to={'trasporter_type': 'rimorchio'}, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='trailer', to='allapps.Transporter', verbose_name='Rimorchio')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('input_reference', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='allapps.Input_App2')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('date', models.DateField(blank=True, verbose_name='data missioni')),
                ('truck_is_used', models.BooleanField(default=False, verbose_name='utilizzo camion')),
                ('visit_order', models.CharField(blank=True, default=None, max_length=500, validators=[django.core.validators.int_list_validator], verbose_name='ordine di visita')),
                ('node_name', models.CharField(blank=True, default=None, max_length=500, validators=[django.core.validators.int_list_validator], verbose_name='nome destinazione')),
                ('lat', models.CharField(blank=True, default=None, max_length=500, validators=[django.core.validators.int_list_validator], verbose_name='latitudine')),
                ('long', models.CharField(blank=True, default=None, max_length=500, validators=[django.core.validators.int_list_validator], verbose_name='longitudine')),
                ('load_unload', models.CharField(blank=True, default=None, max_length=500, validators=[django.core.validators.int_list_validator], verbose_name='carico/scarico')),
                ('arrival_time', models.CharField(blank=True, default=None, max_length=500, validators=[django.core.validators.int_list_validator], verbose_name='orario di arrivo')),
                ('departure_time', models.CharField(blank=True, default=None, max_length=500, validators=[django.core.validators.int_list_validator], verbose_name='orario di partenza')),
                ('leaving_load', models.CharField(blank=True, default=None, max_length=500, validators=[django.core.validators.int_list_validator], verbose_name='carico alla partenza')),
                ('input_reference', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, to='allapps.Input_App2')),
                ('truck', models.ForeignKey(default=None, on_delete=django.db.models.deletion.PROTECT, to='allapps.Truck')),
            ],
            options={
